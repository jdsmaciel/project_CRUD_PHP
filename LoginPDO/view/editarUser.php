...
<html>
    ...
    <body>
        <h1>Editar User</h1>
        <form action="<?php $cadUser->updateUser(); ?>" method="post">
            <input type="hidden" required value="<?php echo $user[0]['idUser']; ?>" name="idUser"/>
            <input type="text" required value="<?php echo $user[0]['nome']; ?>" name="nomeUser"/>
            <br></br>
            <input type="email" disabled value="<?php echo $user[0]['email']; ?>" name=""/>
            <br></br>
